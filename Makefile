...
build-capture: lint-capture
	...
	sudo docker buildx build -t wildflowerschools/classroom-node-capture:v$(shell cat capture/VERSION) --platform linux/arm64,linux/arm/v7 -f capture/Dockerfile --push .
