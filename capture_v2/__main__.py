...
def main():
    ...
    try:
        ...
        camera_controller = CameraController(main_config={"size": (1296, 972), "format":"YUV420"},
        ...
        camera_controller.add_encoder(encoder=mjpeg_main_res_encoder, name="LoRes MMJPEG Encoder - For Streaming HTTP Server", stream_type="main")
        camera_controller.add_encoder(encoder=mjpeg_lo_res_encoder, name="HiRes MMJPEG Encoder - For Capture Loop", stream_type="lores")
